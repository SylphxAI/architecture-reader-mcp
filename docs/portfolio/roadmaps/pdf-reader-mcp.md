...
- Add Rust native modules where they materially improve parsing, search,
  rendering, OCR orchestration, hashing, and layout indexing.
...
- Ship optional binary packages for native acceleration.
...
- Benchmarks prove native acceleration before it becomes default.
